...
class ScribeFormApplication extends FormApplication {
    ...
    update_export = function() {
        let md = [
            "watermark (",
            "Generated by pf2e-export-scribe",
            ")",
            ""
        ];
        if (document.getElementById("pf2e-export-scribe-include-ancestry").checked && document.getElementById("pf2e-export-scribe-content-ancestry").textContent.replace(/\s+/,'') != "") {
            md.push(document.getElementById("pf2e-export-scribe-content-ancestry").textContent);
            md.push('');
        }
        if (document.getElementById("pf2e-export-scribe-include-ancestry-features").checked && document.getElementById("pf2e-export-scribe-content-ancestry-features").textContent.replace(/\s+/,'') != "") {
            md.push('## Ancestry Features');
            md.push(document.getElementById("pf2e-export-scribe-content-ancestry-features").textContent);
            md.push('');
        }
        if (document.getElementById("pf2e-export-scribe-include-background").checked && document.getElementById("pf2e-export-scribe-content-background").textContent.replace(/\s+/,'') != "") {
            md.push(document.getElementById("pf2e-export-scribe-content-background").textContent);
            md.push('');
        }
        if (document.getElementById("pf2e-export-scribe-include-class").checked && document.getElementById("pf2e-export-scribe-content-class").textContent.replace(/\s+/,'') != "") {
            md.push(document.getElementById("pf2e-export-scribe-content-class").textContent);
            md.push('');
        }
        if (document.getElementById("pf2e-export-scribe-include-class-features").checked && document.getElementById("pf2e-export-scribe-content-class-features").textContent.replace(/\s+/,'') != "") {
            md.push('## Class features');
            md.push(document.getElementById("pf2e-export-scribe-content-class-features").textContent);
            md.push('');
        }
        if (document.getElementById("pf2e-export-scribe-include-feats").checked && document.getElementById("pf2e-export-scribe-content-feats").textContent.replace(/\s+/,'') != "") {
            md.push('# Feats');
            md.push(document.getElementById("pf2e-export-scribe-content-feats").textContent);
            md.push('');
        }
        if (document.getElementById("pf2e-export-scribe-include-spells").checked && document.getElementById("pf2e-export-scribe-content-spells").textContent.replace(/\s+/,'') != "") {
            md.push('# Spells');
            md.push(document.getElementById("pf2e-export-scribe-content-spells").textContent);
            md.push('');
        }
        if (document.getElementById("pf2e-export-scribe-include-formulas").checked && document.getElementById("pf2e-export-scribe-content-formulas").textContent.replace(/\s+/,'') != "") {
            md.push('# Formulas');
    ...
    getData = function() {
        ...
        let formulas = [];
        this.actor.system.crafting.formulas.map(i => fromUuidSync(i.uuid))
            .sort( (a,b) => (a.name < b.name ? -1 : (a.name > b.name ? 1 : 0)) )
            .forEach(
                (f) => {
